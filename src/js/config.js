...
export const TIMEOUT_SEC = 10; //used for the timer that races with the call to the API. Pervents taking too long to display results
...
</div> <!-- end of second upload column -->
